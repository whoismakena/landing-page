        ...
        <div className="App-Container">
              ...
              <Grid item md={12} lg={6} className="Details-Container">
                <div>
                  ...
                  <span className="Subtitle">
                    Having a terrible hangover after a fun night out? Kick off
                    the day on a clean slate with an uplifting mix of green tea,
                    ginger and calming mint. We all deserve a second chance.
                  </span>
                </div>
              </Grid>
          ...
          >
            ...
            <span className="Tea-Desc">
              Kericho Gold is a special blend of fine teas from some of the best
              tea estates in Kenya; carefully selected weekly by expert Tea
              Tasters for the richness of their taste, flavour and aroma to
              bring out the quality and ensure that high standards are
              maintained, guaranteeing you a perfect cup of tea every time.
              Kericho Gold Teas and Infusions are tasty and full of fragrance
              that is why there is no added sugar, no artificial colors or
              preservatives, just the great tasting flavors.
            </span>
            <span className="Tea-Desc Tea">
              The premium Hangover tea range includes green tea, mint, and
            ...
            <span className="Tea-Desc Tea">
              Ideal Partner: Passionate, adventurous, willing to try something
              new and exciting, and looking for a close relationship. Sounds
              like you? Then stop searching, pick me and love me forever.
            </span>
          </div>
